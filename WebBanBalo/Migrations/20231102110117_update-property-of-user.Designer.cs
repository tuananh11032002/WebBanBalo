...
namespace WebBanBalo.Migrations
{
    ...
    [Migration("20231102110117_update-property-of-user")]
    partial class updatepropertyofuser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebBanBalo.Model.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 2, 18, 1, 16, 973, DateTimeKind.Local).AddTicks(6334));
