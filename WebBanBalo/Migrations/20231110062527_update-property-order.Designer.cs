...
namespace WebBanBalo.Migrations
{
    ...
    [Migration("20231110062527_update-property-order")]
    partial class updatepropertyorder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebBanBalo.Model.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 10, 13, 25, 26, 977, DateTimeKind.Local).AddTicks(3879));
