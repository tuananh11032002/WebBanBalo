...
namespace WebBanBalo.Migrations
{
    ...
    [Migration("20231103053934_update-relationship-user-message2")]
    partial class updaterelationshipusermessage2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebBanBalo.Model.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 3, 12, 39, 34, 703, DateTimeKind.Local).AddTicks(8296));
