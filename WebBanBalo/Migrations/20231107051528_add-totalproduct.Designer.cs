...
namespace WebBanBalo.Migrations
{
    ...
    [Migration("20231107051528_add-totalproduct")]
    partial class addtotalproduct
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebBanBalo.Model.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 7, 12, 15, 28, 523, DateTimeKind.Local).AddTicks(7091));
