...
namespace WebBanBalo.Migrations
{
    ...
    [Migration("20231108155336_add-title-category")]
    partial class addtitlecategory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebBanBalo.Model.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 8, 22, 53, 36, 225, DateTimeKind.Local).AddTicks(1686));
