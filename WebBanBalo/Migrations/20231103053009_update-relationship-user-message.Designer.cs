...
namespace WebBanBalo.Migrations
{
    ...
    [Migration("20231103053009_update-relationship-user-message")]
    partial class updaterelationshipusermessage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebBanBalo.Model.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 3, 12, 30, 9, 417, DateTimeKind.Local).AddTicks(5143));
