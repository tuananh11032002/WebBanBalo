...
namespace WebBanBalo.Migrations
{
    ...
    [Migration("20231105045228_add-default-product-status")]
    partial class adddefaultproductstatus
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebBanBalo.Model.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 5, 11, 52, 27, 975, DateTimeKind.Local).AddTicks(8272));
