...
namespace WebBanBalo.Migrations
{
    ...
    [Migration("20231103060019_update-relationship-user-message5")]
    partial class updaterelationshipusermessage5
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebBanBalo.Model.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 3, 13, 0, 19, 228, DateTimeKind.Local).AddTicks(7998));
