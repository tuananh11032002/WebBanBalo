...
namespace WebBanBalo.Migrations
{
    ...
    [Migration("20231103055621_update-relationship-user-message4")]
    partial class updaterelationshipusermessage4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebBanBalo.Model.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 3, 12, 56, 20, 982, DateTimeKind.Local).AddTicks(1326));
